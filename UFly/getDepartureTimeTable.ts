...
exports.getDepartureTimeTable = functions.https.onRequest(async (req, resp)=>{
  ...
  const options = {
    method: 'GET',
    url: `http://api.aviationstack.com/v1/flights?access_key=${access_key}&limit=${limit}&dep_iata=${airport}&flight_status=active`, //AQUI VAN LES HORES PER ACOTAR-HO
  }
  try{
