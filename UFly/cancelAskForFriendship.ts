...
export const cancelAskForFriendship = functions.https.onCall(async (data, context) => {
  ...
  return db.doc(`users/${cancelFriend}`).update({
    ...
    console.log(`${cancelFriend} will no be able to accept your petiton for a friendship`);
    return true;
  }).catch(console.error);
